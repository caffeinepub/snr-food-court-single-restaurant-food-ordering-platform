...
export class Backend implements backendInterface {
    ...
    async getSingleRestaurant(): Promise<Restaurant> {
        if (this.processError) {
            try {
                ...
                return from_candid_Restaurant_n29(this._uploadFile, this._downloadFile, result);
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
            }
    ...
    async updateCartItems(arg0: Array<UpdateCartItemInput>, arg1: boolean): Promise<Cart> {
        if (this.processError) {
            try {
                const result = await this.actor.updateCartItems(to_candid_vec_n33(this._uploadFile, this._downloadFile, arg0), arg1);
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
    ...
    async updateMenuItem(arg0: string, arg1: string | null, arg2: string | null, arg3: bigint | null, arg4: string | null, arg5: boolean | null, arg6: ExternalBlob | null): Promise<void> {
        if (this.processError) {
            try {
                const result = await this.actor.updateMenuItem(arg0, to_candid_opt_n36(this._uploadFile, this._downloadFile, arg1), to_candid_opt_n36(this._uploadFile, this._downloadFile, arg2), to_candid_opt_n37(this._uploadFile, this._downloadFile, arg3), to_candid_opt_n36(this._uploadFile, this._downloadFile, arg4), to_candid_opt_n38(this._uploadFile, this._downloadFile, arg5), await to_candid_opt_n39(this._uploadFile, this._downloadFile, arg6));
                return result;
            } catch (e) {
                this.processError(e);
                throw new Error("unreachable");
...
function from_candid_CuisineType_n31(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: _CuisineType): CuisineType {
...
function from_candid_opt_n26(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: [] | [_FoodCourtProfile]): FoodCourtProfile | null {
...
async function from_candid_record_n30(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: {
    ...
    return {
        name: value.name,
        uuid: value.uuid,
        cuisineType: from_candid_CuisineType_n31(_uploadFile, _downloadFile, value.cuisineType),
        description: value.description,
...
function to_candid_UpdateCartItemInput_n34(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: UpdateCartItemInput): _UpdateCartItemInput {
...
function to_candid_vec_n33(_uploadFile: (file: ExternalBlob) => Promise<Uint8Array>, _downloadFile: (file: Uint8Array) => Promise<ExternalBlob>, value: Array<UpdateCartItemInput>): Array<_UpdateCartItemInput> {
    return value.map((x)=>to_candid_UpdateCartItemInput_n34(_uploadFile, _downloadFile, x));
}
